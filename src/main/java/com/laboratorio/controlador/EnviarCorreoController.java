...
public class EnviarCorreoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Estructura esperada: {"email":"paciente@gmail.com", "pdfBase64":"JVBERi0xLj...", "nombreArchivo":"1000_PACIENTE.pdf"}
        ...
        String remitente = "especialidades.prolab@gmail.com";         // Tu correo real del laboratorio
        String password = "dnfo nwut mmoa ucyd"; // Contraseña de aplicación de Google
        ...
        try {
            ...
            if (pdfBase64 != null && !pdfBase64.isEmpty()) {
                // Limpiar encabezado data URI si viniera incluido (ej: "data:application/pdf;base64,...")
